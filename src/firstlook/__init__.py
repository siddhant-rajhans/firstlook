...
from .descent import descent, Descent
...
__all__ = [
    ...
    "leaderboard", "explain", "diagnose", "descent", "Report", "Recommendation",
    "Baseline", "Leaderboard", "Entry", "Narrative", "Completer", "Diagnosis",
    "Finding", "Descent", "THEME", "__version__",
]
